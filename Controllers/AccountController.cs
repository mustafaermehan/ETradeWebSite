...
using ETicaretSitem.Identity;
using ETicaretSitem.Models;
...
namespace ETicaretSitem.Controllers
{
        ...
        public ActionResult Login(Login model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    authProperties.IsPersistent = model.RememberMe; //sistemin devamlı açık yada kapalı olmasını sağlarız
                    authManager.SignIn(authProperties, Identityclaims);
                    if (!String.IsNullOrEmpty(returnUrl)) //sisteme login olmadan sayfalara erişim izni vermeyip login sayfasına yönlendirme
                    {
